...
// include: /tmp/claude-501/tmp9m2i7hhv.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'quoridor.data';
      var REMOTE_PACKAGE_BASE = 'quoridor.data';
...
Module['FS_createPath']("/assets", "img", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_quoridor.data');
      }
      Module['addRunDependency']('datafile_quoridor.data');
    ...
    loadPackage({"files": [{"filename": "/assets/fonts/RobotoMono-Regular.ttf", "start": 0, "end": 109212}, {"filename": "/assets/img/bbox.png", "start": 109212, "end": 109798}, {"filename": "/assets/img/blank.png", "start": 109798, "end": 109867}, {"filename": "/assets/img/blueX.png", "start": 109867, "end": 112897}, {"filename": "/assets/img/redSquare.png", "start": 112897, "end": 112972}], "remote_package_size": 112972});

  })();

// end include: /tmp/claude-501/tmp9m2i7hhv.js
// include: /tmp/claude-501/tmpowgjs1qd.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/claude-501/tmpowgjs1qd.js
// include: /tmp/claude-501/tmp2vggb1et.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/claude-501/tmp2vggb1et.js
...
function findWasmBinary() {
  return locateFile('quoridor.wasm');
}
